...
--------
  ...
  python scripts/sim_webhook.py email-hangseng --account "REDACTED-a-real-Hang-Seng-account" --amount 300 --currency HKD
...
def cmd_email_hangseng(args) -> dict:
    ...
    body = (
        ...
        f"由 From: {args.account or 'REDACTED-a-real-Hang-Seng-account'}\n"
        f"{cur}{args.amount:.2f}\n"
        f"至 To: {args.to or 'REDACTED-a-real-Hang-Seng-payee-account'}\n"
