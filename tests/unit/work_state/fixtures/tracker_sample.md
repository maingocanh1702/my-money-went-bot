...
| work-state-engine-1a | Wave 0 follow-up | Work-State Engine — Phase 1a (skeleton + filesystem + git) | ⬜ | `feat/MYM-1-work-state-engine-1a` | 🔒I 🔒X | **Ready to kickoff 2026-05-20.** **Linear:** [MYM-1](https://linear.app/maingocanh/team/MYM/issue/MYM-1) — workspace `maingocanh`, project `Work-State Engine`, milestone `Phase 1a`, P1 manual_only. **Spec:** `docs/operations/dashboard-plan-state-split.md` v1.2.1 Accepted (founder sign-off 2026-05-20 after Codex 3 rounds, 23 findings resolved). **Phase 0 audit:** `docs/operations/phase-0-audit-report-2026-05-20.md` (defaults strategy + tracker schema gap mapped). **Prompt:** `docs/autopilot/prompts/work-state-engine-phase-1a-autopilot.md` (placeholders substituted). **Scope:** `scripts/work_state/` skeleton (models/plan_reader/event_engine/status_machine/progress/state_store) + 2 collectors (filesystem + git). 2 work-days. Codex 2× consecutive clean required. Out of scope: github/ci/railway collectors (Phase 1b), runtime urgency (Phase 1d), CI enforcement (Phase 2). |
