...
from scripts.work_state.signal_collectors.ci import CiSignals
from scripts.work_state.signal_collectors.github import GithubSignals
from scripts.work_state.signal_collectors.railway import RailwaySignals
