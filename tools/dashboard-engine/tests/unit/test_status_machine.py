...
class TestComputeStatus:
    ...
    def test_deployed(self) -> None:
        from work_state.status_machine import compute_status
...
class TestHumanStatus:
    ...
    def test_backlog(self) -> None:
        from work_state.status_machine import compute_human_status
...
class TestMultiBranchAggregation:
    ...
    def test_min_progressed_status(self) -> None:
        from work_state.status_machine import aggregate_multi_branch_status
    ...
    def test_overlay_union(self) -> None:
        from work_state.status_machine import aggregate_multi_branch_overlays
...
class TestCanonicalOverlaysSpecParity:
    ...
    def test_canonical_overlays_count_matches_spec_8_2(self) -> None:
        ...
        from work_state.status_machine import CANONICAL_OVERLAYS
