...
from work_state.state_store import write_current_state
...
class TestStatusAutoFlipNoTriggerDrift:
    ...
    def test_status_change_no_tracker_modified(self) -> None:
        from work_state.status_machine import compute_overlays
...
def _patched_run(
    ...
    *,
    ...
    with (
        ...
        patch("work_state.engine.collect_git_signals", return_value=_git_signals()),
        patch("work_state.engine.collect_github_signals", return_value=_gh_signals()),
        patch("work_state.engine.collect_ci_signals", return_value=_ci_signals()),
        patch("work_state.engine.collect_railway_signals", return_value=_rw_signals()),
    ):
