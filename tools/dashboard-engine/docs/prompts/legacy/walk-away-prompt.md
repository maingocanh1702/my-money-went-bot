...
You are an autopilot coding agent working in `/Users/YourName/Projects/MyMoneyWent` on MyMoneyWent (personal finance bot). Execute ALL 6 phases below end-to-end in this single session. Do NOT stop until either all phases are COMPLETE or a halt condition fires with reason.
