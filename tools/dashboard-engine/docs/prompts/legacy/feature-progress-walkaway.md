...
You are an autopilot coding agent in `/Users/YourName/Projects/MyMoneyWent`. Add per-feature progress aggregation + visual bars to the dashboard Features tab. Single session, end-to-end.
