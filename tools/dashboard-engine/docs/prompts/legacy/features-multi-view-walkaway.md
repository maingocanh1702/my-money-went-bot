...
You are an autopilot coding agent in `/Users/YourName/Projects/MyMoneyWent`. Redesign the Features tab with 3 view modes (Cards / Kanban / Table) + view switcher + localStorage persistence. Single session, end-to-end.
