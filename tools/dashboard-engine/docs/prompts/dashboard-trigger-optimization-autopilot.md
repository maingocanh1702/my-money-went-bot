...
You are working in `/Users/YourName/Projects/MyMoneyWent` on MyMoneyWent — VN-first personal finance tracker. NO prior conversation context. This prompt is self-contained.
