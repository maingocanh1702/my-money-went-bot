...
You are working in /Users/YourName/Projects/MyMoneyWent-MYM-8 on MyMoneyWent
...
```bash
cd /Users/YourName/Projects/MyMoneyWent-MYM-8
...
cp "/Users/YourName/Library/Application Support/Claude/local-agent-mode-sessions/<UUID>/local_<UUID>/outputs/MYM-8-doc-change-hash-dedup-autopilot.md" \
...
ln -s /Users/YourName/Projects/MyMoneyWent/.venv .venv
source .venv/bin/activate
...
# - Linear MYM-8 → Done
# - cd /Users/YourName/Projects/MyMoneyWent && git worktree remove ../MyMoneyWent-MYM-8
```
