...
def parse_email(from_addr: str, subject: str, body: str, date: str) -> dict | None:
    ...
    2. Email forward từ Gmail account khác (vd REDACTED-maintainers-forwarder-local-part → maingocanh1702):
...
def _parse_hangseng(subject: str, body: str, date: str) -> dict | None:
    ...
    Reference body (outgoing transfer to non-registered payee):
      ...
      由 From: REDACTED-a-real-Hang-Seng-account
      HKD300.00
      至 To: REDACTED-a-real-Hang-Seng-payee-account
      ...
      預設銀行 Default bank: Y
      交易號碼 Transaction ID: REDACTED-a-real-Hang-Seng-transaction-id
      參考編號 Reference number: REDACTED-a-real-Hang-Seng-reference-number
    ...
    #   "至 To: REDACTED-a-real-Hang-Seng-payee-account"           — masked account number
    ...
    # "由 From: REDACTED-a-real-Hang-Seng-account" → "REDACTED-a-real-Hang-Seng-account"
