...
> **Trạng thái:** Draft
> **Tham chiếu:** [brd-vi.md](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) v3.1.0 · [tdd-vi.md](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) v1.9.0 · [feature-spec-messenger-channel](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md) v1.1.1 · [impl plan VietQR+email](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md) v1.0.0 · [impl plan Zalo channel](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-zalo-channel-core.md) v0.6.0
>
> **🌐 SCOPE NOTE:** PRD này là **canonical product spec cho 🇻🇳 thị trường Việt Nam** (Tiền Về Nơi Đâu — tienvenoidau.com). Transaction capture (SePay + VN bank email parsing), 3 personas (Minh/Linh/Hùng+), pricing (79k/199k VND) đều VN-specific. **Global market** có PRD riêng — [prd-en.md](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-en.md) (My Money Went — mymoneywent.com). Per [ADR-0001](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0001-monorepo-not-split-repos.md), shared foundation specs (DB schema, messenger interface, auth) apply cho cả 2 markets.
>
...
| Payment | **Bank transfer + auto-detect** qua SePay primary + Email backup (xem [feature-spec-payment-bank-transfer.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md)) · PayPal/USDT defer Phase 2 |
| Backup | Backblaze B2 daily với SSE-B2 server-side encryption + `pg_dumpall --globals-only` cho roles |
| Admin tools | Telegram commands restricted bằng `ADMIN_TELEGRAM_IDS` (comma-separated, multi-admin), rate limit `ADMIN_RATE_LIMIT_PER_MIN=30` default. `/admin_help` hybrid auto-generated từ `@admin_only` registry. Detail: [feature-spec-admin-tools v1.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-admin-tools.md) |
| Observability | Sentry + Railway metrics + UptimeRobot. Founder daily dashboard `/admin_stats`, cost dashboard `/admin_cost`, per-user troubleshooter `/admin_user`. Error budget 0.1% policy. Detail: [observability-plan v1.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/operations/observability-plan.md) |
| Disaster recovery | 8 scenarios documented + quarterly drill. RTO 2-4h, RPO 24h. `BOT_TOKEN_BACKUP` ready, `@FinTrackUpdates` channel for out-of-band notification. Detail: [DR runbook v1.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/runbooks/disaster-recovery.md) |
...
> **Pricing bump:** Pro 79k→99k, Business 199k→299k ship cùng Family launch. Grandfather 6 tháng giá cũ cho existing subscriber. Xem BRD §5.1 + [feature-family-plan.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/drafts/feature-family-plan.md).
>
...
> **Family Plan scope:** Target phụ huynh quản lý chi tiêu con **13-17 tuổi**. Co-parent ngang quyền owner trừ billing. Consent disclosure mandatory. Permission: View + Set Budget + Alerts (KHÔNG approve-before-spend). Spec đầy đủ: [feature-family-plan.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/drafts/feature-family-plan.md).
...
**Payment flow:** Detail spec ở [feature-spec-payment-bank-transfer v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md) + [implementation-plan-payment-vietqr-email v1.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md). Tóm tắt:
...
| **Error budget** | ≤0.1% error rate rolling 30-day window. Policy 3-tier (>50% remain → ship features / 0-50% → slow down / <0% → freeze). Detail: [observability §4b](file:///Users/YourName/Projects/MyMoneyWent/docs/operations/observability-plan.md) |
| **Disaster recovery** | RTO ≤2h (DB corruption), ≤4h (Railway outage), ≤5min (BOT_TOKEN compromise). 8 scenarios documented: [DR runbook](file:///Users/YourName/Projects/MyMoneyWent/docs/runbooks/disaster-recovery.md) |
...
### 7.2. References
- [BRD-vi v3.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md)
- [TDD-vi v1.9.0](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md)
- [Feature spec: Personal vs Business toggle](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-personal-business-toggle.md)
- [Feature spec: Refactor personal → SaaS multi-tenant](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md)
- [Feature spec: Payment via bank transfer v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md)
- [Feature spec: Family Plan v1.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/drafts/feature-family-plan.md)
- [Feature spec: Funding Sources v1.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md)
- [Feature spec: Pricing tiers v1.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-pricing-tiers.md)
- [Feature spec: Multi-channel Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md)
- [Decision: Onboarding UI strategy v1.0.1](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md)
- [Feature spec: Admin tools & audit](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-admin-tools.md)
- [Implementation plan: VietQR + email parallel](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md)
- [Implementation plan: scale to 500 users and more](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-500-users-and-more.md)
- [Runbook: Disaster recovery](file:///Users/YourName/Projects/MyMoneyWent/docs/runbooks/disaster-recovery.md)
- [Observability plan](file:///Users/YourName/Projects/MyMoneyWent/docs/operations/observability-plan.md)
...
- [Implementation plan: Zalo channel core v0.6.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-zalo-channel-core.md)
