...
> **Cập nhật:** 2026-05-25 10:07 · **Branch hiện tại:** `main`
...
| `doc-change-hash-dedup` | Doc-change hash-aware dedup + engine emission wire | ✅ Merged | BACKLOG ✓ normal | `feat/MYM-8-doc-change-hash-dedup` |
