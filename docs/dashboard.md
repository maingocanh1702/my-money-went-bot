...
> **Cập nhật:** 2026-05-21 20:24 · **Branch hiện tại:** `main`
...
| `dashboard-live-view-B` | Dashboard Live View — Phase B (doc-change awareness) | ✅ Merged | WAITING | `feat/MYM-7-dashboard-live-view-B` |
| `work-state-engine-1d` | Work-State Engine — Phase 1d (urgency + MAX agg + foundation_change + projection) | ✅ Merged | WAITING | `feat/MYM-10-work-state-1d-urgency-bundle` |
