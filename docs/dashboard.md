...
> **Cập nhật:** 2026-05-12 19:51 · **Branch hiện tại:** `feat/F07-settings`
...
- **Gates:** 🔒T 🔒X
- **Phase:** Phase 2
- **Notes:** Locale + TZ + daily recap toggle. W0.8 merged → unblocked. Autopilot branch in Codex/fix review.
