...
> **Tham chiếu:** [PRD-vi v1.7.1 §3.1](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md) · [BRD-vi v3.1.0 §4.1](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) · [Feature: i18n](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md)
...
> **i18n:** Language selection là bước đầu tiên của onboarding. Auto-detect từ Telegram `language_code` / Discord interaction `locale` / Messenger profile, user confirm/override. Tất cả messages sau đó sẽ serve qua `t(user.locale, key)`. Xem [feature-i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md).
...
| 13 | User mới | Click Family invite link → `/start fam_<token>` | Detect invite token → setup minimal account → show Family disclosure screen (consent gate) trước khi join. Xem [feature-family-plan.md §3.2](file:///Users/YourName/Projects/MyMoneyWent/docs/features/drafts/feature-family-plan.md). |
...
> Text rendered via `t(user.locale, 'onboard.choose_lang')`. Xem [feature-i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md).
