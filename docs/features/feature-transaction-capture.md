...
> **Tham chiếu:** [PRD-vi v1.7.1 §3.2](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md)
...
> **i18n:** Transaction notification messages served via `t(user.locale, key)`. Xem [feature-i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md).
>
> **Cross-feature:** Mỗi tx được attach FK vào một **funding source** (TK ngân hàng / thẻ / ví) sau khi parse — xem [feature-funding-sources.md (F08)](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md). Pipeline insert FK trước category picker.
...
> **F08 ownership:** column `funding_source_id` được F08 add qua `ALTER TABLE` (xem [feature-funding-sources.md §4](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md)). F02 runtime PHẢI populate column này — null chỉ acceptable khi resolve fail (xem §10 acceptance criteria). FK `ON DELETE SET NULL` đảm bảo tx không bị xoá khi funding source bị xoá.
...
**Resolve failure handling:** nếu `funding_sources.resolve_funding_source(...)` raise exception, pipeline log + tiếp tục với `funding_source_id=NULL`. Tx không bị mất; user vẫn nhận picker bình thường. Xem [feature-funding-sources-tech.md §4.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/BE/feature-funding-sources-tech.md).
...
**Funding source integration ([F08](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md)):**
