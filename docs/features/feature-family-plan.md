...
> **Tham chiếu:**
> - [feature-pricing-tiers.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-pricing-tiers.md) (F06) — cần addendum thêm cột Family
> - [feature-funding-sources.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md) (F08) — cần entitlement/visibility join với `family_members`; KHÔNG thêm column trên `funding_sources` (ownership giữ ở user-level)
> - [feature-saas-refactor.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md) — multi-tenant boundary, RBAC
> - [feature-onboarding.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-onboarding.md) (F01) — extend với invite flow
> - [BRD-vi §5 Pricing](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) — cần thêm tier Family + bump Pro/Business
> - [PRD-vi §3.6 Tier Gating](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md)
...
> **Note:** API Endpoints, Error Codes, State Machine, Scenarios by Status, Timeout Spec, Caching Strategy → xem [BE/feature-family-plan-tech.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/BE/feature-family-plan-tech.md)
