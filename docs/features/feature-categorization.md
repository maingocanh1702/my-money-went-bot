...
> **Tham chiếu:** [PRD-vi v1.7.1 §3.3](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md)
...
> **i18n:** All user-facing messages (picker prompt, confirmation, error) served via `t(user.locale, key)`. Button labels bilingual. Xem [feature-i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md).
