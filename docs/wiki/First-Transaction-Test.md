...
On **Zalo**: send `/today` to your Zalo bot instead. If it doesn't reply, check `ZALO_ENABLED`, the `/zalo/webhook` registration, and `ZALO_SECRET_TOKEN` — see [Zalo Setup](Zalo-Setup).
