...
> **Cập nhật:** 2026-05-13 (post Wave 0 + W0.7)
...
- [ ] **W0.7** — commit + PR: public `request_id` helpers + F02 xfail contract pin (code done)
- [ ] **W0.8** — webhook `display_suffix` migration → [plan](implementation-plans/phase-1-foundation-remaining.md) — **blocks F07**
...
| Automation tooling | `.autopilot/` folder | — |
