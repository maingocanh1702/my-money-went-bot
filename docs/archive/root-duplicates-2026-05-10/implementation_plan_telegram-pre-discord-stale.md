...
> **Tham chiếu:** [Feature: Onboarding](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_onboarding.md) · [Feature: i18n](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_i18n.md) · [Feature: Transaction Capture](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_transaction_capture.md) · [Feature: Categorization](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_categorization.md) · [Feature: Category Management](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_category_management.md) · [Feature: Reports](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_reports.md) · [Feature: Pricing & Tiers](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_pricing_tiers.md) · [Feature: Settings](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_settings.md) · [Feature: Scheduled Jobs](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_scheduled_jobs.md) · [Feature: SaaS Refactor](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_saas_refactor.md) · [TDD v1.7.0](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd.md) · [BRD v2.9.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md)
...
- Messenger channel (Phase 6, separate [plan](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation_plan_messenger.md))
- Payment integration (Phase 6, separate [plan](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md))
- Admin tools (Phase 6)
...
|-----|------|--------|-------------|
| 1 | Railway PostgreSQL setup + DDL (`users`, `categories`, `sub_categories`, `transactions`, `bot_state`, `scheduled_jobs`, `admin_audit_log`, `analytics_events`) | All tables created | [SaaS Refactor](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_saas_refactor.md) |
...
| 4 | `services/channels/telegram.py` — `TelegramSender.send_text()`. FastAPI app + `/webhook/telegram` endpoint. **`i18n/` module:** `__init__.py` (`t()` helper), `vi.py`, `en.py` language packs (~106 keys) | Bot responds to `/start` + i18n foundation | [Onboarding](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_onboarding.md) · [i18n](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_i18n.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 11 | `handlers/manage.py` — `/manage` list categories. Show name, budget, spent | Category list | [Cat Mgmt](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_category_management.md) |
...
| 14 | `handlers/report.py` — `/status` monthly overview with progress bars | Monthly report | [Reports](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_reports.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 16 | `/help` command (auto-generated from handler registry). `/settings` basic display | Help + settings | [Settings](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_settings.md) |
| 17 | Settings: timezone change + webhook token regen + daily recap toggle + **language change** | Settings complete | Settings · i18n |
| 18 | Tier limit engine: `services/tier_check.py`. Integrate into manage + report | Tier enforcement | [Pricing](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_pricing_tiers.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 21 | `/hook/{token}` endpoint. `handlers/sepay.py` — parse SePay payload | Webhook receives | [Tx Capture](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_transaction_capture.md) |
| 22 | `services/tx_pipeline.py` — normalize → dedup → stale → tier → INSERT | Pipeline complete | Tx Capture |
| 23 | `handlers/transaction.py` — category picker (inline keyboard). 2-level: parent → sub → confirm | Picker UI | [Categorization](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_categorization.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 26 | `services/scheduler.py` — APScheduler poll loop. Daily recap fire 23:00 | Scheduler running | [Sched Jobs](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_scheduled_jobs.md) |
