...
- Telegram-imposed rate limit ~30 msg/s toàn bot → ở ≥500 active users với spike (vd 23:00 daily recap) cần bot pool. Roadmap: 1 bot (0-500) → bot pool 2-5 (500-2000) → Local Bot API server self-host (2000+). Detail xem [PRD section 5.4.2](file:///Users/maingocanh/Projects/My Money Went/docs/prd.md).
...
| 9 | **Compliance VN (Nghị định 13/2023 PDPA)** | Cao | Privacy policy rõ, data retention policy, breach response plan. PDPA breach runbook deferred — re-eval @ 200 users hoặc post-incident (xem [implementation plan §5b](file:///Users/maingocanh/Projects/My Money Went/docs/implementation-plan-500-users-and-more.md)) |
...
- [ ] **Disaster recovery runbook** ([docs/runbooks/disaster-recovery.md](file:///Users/maingocanh/Projects/My Money Went/docs/runbooks/disaster-recovery.md)) — 8 scenarios documented (incl. Scenario G SePay outage, Scenario H abuse/spam)
