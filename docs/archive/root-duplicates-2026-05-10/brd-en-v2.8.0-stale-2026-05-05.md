...
### 1.1. Tên sản phẩm
**My Money Went** — Telegram Bot tự động theo dõi tài chính cá nhân và shop nhỏ qua SePay.
...
- Telegram-imposed rate limit ~30 msg/s toàn bot → ở ≥500 active users với spike (vd 23:00 daily recap) cần bot pool. Roadmap: 1 bot (0-500) → bot pool 2-5 (500-2000) → Local Bot API server self-host (2000+). Detail xem [PRD section 5.4.2](file:///Users/YourName/Projects/My Money Went/docs/prd.md).
...
| 4 | Platform #2 | Messenger / Zalo integration | Validate (chưa cần live) |
...
**Đây là primary persona cho Business tier — revenue driver thực sự của My Money Went ở mid-stage.**
...
**WTP cho My Money Went Business $9 (220k VND):**
...
| 4 | **Email forwarding ingest** | User chỉ muốn email → bot cấp unique inbound address `u<id>@in.mymoneywent.com` → user setup forwarding rule trong Gmail/Outlook → bot parse email tự động | All |
...
| 9 | **Auto-categorization (rule-based)** | Tự động phân loại giao dịch theo nội dung (description matching). **Platform default rules** cho VN phổ biến (SHOPEE, GRAB, LAZADA...) + **user custom rules** (keyword → category). Free: system defaults only. Pro: +10 custom rules. Business: unlimited | All (tiered) |
...
| Auto-categorization **ML upgrade** | Nâng cấp rule-based → ML model (≥10k tx data) | Backlog |
...
| 4 | Inventory management | Wrong product, My Money Went không track tồn kho |
...
**Geo-based pricing (2 domains, 1 codebase):**

| Market | Domain | Pro | Business | Currency |
|---|---|---|---|---|
| 🌍 **Global** (primary) | `mymoneywent.com` | **$4/mo** | **$9/mo** | USD |
...
| Feature | Free | Pro ($4/mo) | Business ($9/mo) |
|---------|------|----------------------|---------------------------|
...
> **Lưu ý SePay:** Khi kết nối bank account qua SePay (cả 3 tier), user tự thanh toán chi phí gói SePay. My Money Went không cover chi phí này.
...
- **Bank transfer + auto-detect** (primary, 0% fee) — user chuyển khoản tới platform's bank account với ref string `PAY-{user_id}-{plan}-{period}-{nonce4}` → SePay webhook detect ≤ 60s, Email parsing backup ≤ 5min. 4-layer fuzzy matching cho typo tolerance. Detail spec: [feature_payment.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_payment.md).
...
|-----------|-------------------|----------------------|
| **Sản phẩm** | Money Lover Free, MISA Money Keeper, Sổ Thu Chi | **Money Lover + Linked Wallet, My Money Went** |
| **TAM VN** | Mass market | Niche (cần connection với bank) |
| **Pricing model** | One-time / Free | Subscription |

### 6.2. So sánh chi tiết

| Sản phẩm | Pricing | Auto-capture? | Personal/Business split? | Channel | So với My Money Went |
|----------|---------|---------------|------------------------|---------|----------------|
| **Money Lover Free** | Miễn phí | ❌ (manual) | ❌ | Mobile app | Khác category — My Money Went auto-capture |
| **Money Lover Premium** | $24.49 one-time | ❌ (vẫn manual) | ❌ | Mobile app | Premium chỉ unlock features (CSV, attach), không có auto-capture |
| **Money Lover + Linked Wallet** | Premium $24.49 + Linked Wallet sub (~$3-5/mo) | ✅ | ❌ | Mobile app | **Đây mới là direct competitor.** My Money Went chạy Telegram (no app install), có Personal/Business split |
| **MISA Money Keeper** | Free + ads | ❌ (manual) | ❌ | Mobile app | Khác category |
| **Sổ Thu Chi MISA** | Free | ❌ | ❌ | Mobile app | Khác category |
| **Excel/Sheets DIY** | Free + 4-6h/tháng | Semi (paste statement) | Manual tag | N/A | My Money Went tự động + chat UX |
| **KiotViet POS** | 200-300k/mo | ✅ (POS scope) | ❌ (POS focused) | Web + mobile | Wrong category cho online seller cá nhân |
| **Kế toán dịch vụ** | 500k-1tr/mo | Manual (kế toán nhận invoice) | ✅ (manual) | Email/Zalo | My Money Went Business: 56% rẻ hơn + real-time |

### 6.3. Direct competitor analysis: Money Lover + Linked Wallet vs My Money Went

Đây là cuộc cạnh tranh thực sự. So sánh head-to-head:

| Dimension | Money Lover + Linked Wallet | My Money Went Pro |
|-----------|------------------------------|-------------|
...
→ **TCO 5 năm gần như tương đương** giữa Money Lover Linked Wallet và My Money Went Pro. Khác biệt chính ở **3 điểm:**

1. **Channel** — Telegram-native vs mobile app: lợi cho My Money Went với user đã sống trong messaging
2. **Personal/Business split** — My Money Went có (Business tier), Money Lover không
3. **Bank coverage** — Money Lover hỗ trợ direct bank, My Money Went qua SePay (cần user có SePay)
...
1. **Telegram-native trong VN context** — đa số online seller đã dùng Telegram (cộng đồng MMO, dropshipper VN active trên Telegram). My Money Went sống trong workflow đã có.
...
| Comparable | Price/year | My Money Went equivalent | Gap |
|-----------|-----------|--------------------|---|
| Money Lover Linked Wallet (auto-capture) | $36-60/năm | Pro $36-48/năm | **Gần ngang** |
| Money Lover Premium one-time + Linked Wallet | $60-84 năm 1 | Pro $36-48 năm 1 | My Money Went rẻ hơn năm đầu, ngang về sau |
| Kế toán dịch vụ | 6-12tr/năm ($240-480) | Business $84-108/năm | My Money Went **80% rẻ hơn** |
| KiotViet POS | 2.4-3.6tr/năm | Business $84-108/năm | My Money Went **70% rẻ hơn** (nhưng feature scope khác) |

→ My Money Went Pro **không phải premium pricing** so với Money Lover Linked Wallet. My Money Went Business là **major value play** so với kế toán dịch vụ và KiotViet.
...
| 2 | **Telegram block ở VN** | Thấp | Messenger là platform #2, validate sẵn sàng |
...
| 9 | **Compliance VN (Nghị định 13/2023 PDPA)** | Cao | Privacy policy rõ, data retention policy, breach response plan. PDPA breach runbook deferred — re-eval @ 200 users hoặc post-incident (xem [implementation plan §5b](file:///Users/YourName/Projects/My Money Went/docs/implementation-plan-500-users-and-more.md)) |
...
| 13 | **Telegram bot suspended** (rare nhưng impactful) | Thấp-Trung bình | `BOT_TOKEN_BACKUP` env var ready. `@MyMoneyWentUpdates` channel làm out-of-band notification path (created pre-launch). DR runbook §6 Scenario D playbook |
...
|-------|-----------|-------------|
| **Phase 1: Foundation** | Tuần 1-2 | Repo mới, DB schema (incl. `admin_audit_log`, `analytics_events`), multi-user routing, **messenger.send() interface abstraction**, Docker Compose setup |
| **Phase 2: Handlers refactor** | Tuần 3-4 | Refactor handlers → multi-user via messenger interface, auth flow, tenant isolation, **admin command authorization framework** (ADMIN_TELEGRAM_IDS) |
...
| **Phase 6: Polish + Deploy** | Tuần 10-12 | **Expanded to 3 tuần** (was 2): scheduling per timezone, onboarding flow polish, **payment integration: bank transfer auto-detect via SePay primary + Email backup + manual review fallback** (8-12 ngày dev), **admin tools commands** (3-5 ngày, [spec](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_admin_tools.md)), **observability dashboard + alerts** (3-5 ngày, [plan](file:///Users/YourName/Projects/MyMoneyWent/docs/observability-plan.md)), Railway production deploy + domain, backup automation + [DR runbook](file:///Users/YourName/Projects/MyMoneyWent/docs/runbooks/disaster-recovery.md). PayPal/USDT defer Phase 2. |
...
- [ ] **Admin tools commands** working end-to-end (xem [feature_admin_tools.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_admin_tools.md)): `/admin_help` (auto-generated), `/admin_resolve`, `/admin_refund`, `/admin_force_plan`, `/admin_stats`, `/admin_cost`. Rate limit 30/min per admin enforced.
- [ ] **`@MyMoneyWentUpdates` Telegram channel created** pre-launch — out-of-band notification path cho bot suspension scenarios
...
- [ ] **Disaster recovery runbook** ([docs/runbooks/disaster-recovery.md](file:///Users/YourName/Projects/My Money Went/docs/runbooks/disaster-recovery.md)) — 8 scenarios documented (incl. Scenario G SePay outage, Scenario H abuse/spam)
...
| Partnership SePay co-marketing | $0 (revenue share) | Tháng 4-6 | Nếu SePay không compete: proposal co-market — SePay user nhận My Money Went Pro 1 tháng free, My Money Went share 20-30% revenue back |
...
| **Email-only seller targeting** | $0 | Tháng 2-3 | Target audience không quen tech: "Bạn nhận email báo giao dịch từ ngân hàng? Forward về bot, có ngay báo cáo." Đây là segment ít competitor đụng vì cần email parsing — My Money Went có moat |
...
| v2.8.0 | 2026-05-06 | **Sync với 3 spec mới (admin-tools v1.1.0, DR runbook v1.1.0, observability v1.1.0) + implementation plan v1.2.0:** (1) **§7 risk register expanded** từ 10 → 14 risks: thêm Risk 11 (abuse/spam attacks — DR §8c playbook), Risk 12 (founder support burnout @ 200+ — C1 automation must ship trước 250), Risk 13 (Telegram bot suspended — BOT_TOKEN_BACKUP + @MyMoneyWentUpdates channel), Risk 14 (cost burn > revenue valley of death 100-300 users — cost dashboard + error budget). Risk 9 PDPA + Risk 10 scale cross-ref tới implementation plan §C4 + §5b. (2) **§10 success criteria** expanded thành 5 groups: Functional (+admin tools commands /admin_help auto-gen, rate limit 30/min, /admin_cost; +@MyMoneyWentUpdates channel), Reliability (+error budget 0.1% rolling 30-day, +7 critical alerts armed, +PLATFORM_TOKEN silence monitoring), Cost (+cost dashboard, +margin >50% sustained), Onboarding (giữ), **Operational readiness mới** (DR runbook 8 scenarios, B2 password manager, SSE-B2 encryption, pg_dumpall globals, trusted contact briefed). (3) No scope/timeline change — tất cả là spec consolidation. |
