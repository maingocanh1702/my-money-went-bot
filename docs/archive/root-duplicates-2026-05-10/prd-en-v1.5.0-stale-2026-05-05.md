...
> **Trạng thái:** Draft
> **Tham chiếu:** [brd.md](file:///Users/YourName/Projects/My Money Went/docs/brd-vi.md) v2.8.0
...
| Payment | **Bank transfer + auto-detect** qua SePay primary + Email backup (xem [feature_payment.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_payment.md)) · PayPal/USDT defer Phase 2 |
| Backup | Backblaze B2 daily với SSE-B2 server-side encryption + `pg_dumpall --globals-only` cho roles |
| Admin tools | Telegram commands restricted bằng `ADMIN_TELEGRAM_IDS` (comma-separated, multi-admin), rate limit `ADMIN_RATE_LIMIT_PER_MIN=30` default. `/admin_help` hybrid auto-generated từ `@admin_only` registry. Detail: [feature_admin_tools.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_admin_tools.md) |
| Observability | Sentry + Railway metrics + UptimeRobot. Founder daily dashboard `/admin_stats`, cost dashboard `/admin_cost`, per-user troubleshooter `/admin_user`. Error budget 0.1% policy. Detail: [observability-plan v1.1.0](file:///Users/YourName/Projects/My Money Went/docs/observability-plan.md) |
| Disaster recovery | 8 scenarios documented + quarterly drill. RTO 2-4h, RPO 24h. `BOT_TOKEN_BACKUP` ready, `@MyMoneyWentUpdates` channel for out-of-band notification. Detail: [DR runbook v1.1.0](file:///Users/YourName/Projects/My Money Went/docs/runbooks/disaster-recovery.md) |
...
**Payment flow:** Detail spec ở [feature_payment.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_payment.md). Tóm tắt:
...
| **Error budget** | ≤0.1% error rate rolling 30-day window. Policy 3-tier (>50% remain → ship features / 0-50% → slow down / <0% → freeze). Detail: [observability §4b](file:///Users/YourName/Projects/My Money Went/docs/observability-plan.md) |
| **Disaster recovery** | RTO ≤2h (DB corruption), ≤4h (Railway outage), ≤5min (BOT_TOKEN compromise). 8 scenarios documented: [DR runbook](file:///Users/YourName/Projects/My Money Went/docs/runbooks/disaster-recovery.md) |
...
### 7.2. References
- [BRD v2.8.0](file:///Users/YourName/Projects/My Money Went/docs/brd-vi.md)
- [TDD](file:///Users/YourName/Projects/My Money Went/docs/tdd.md)
- [Feature: Personal vs Business toggle](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_personal_business_toggle.md)
- [Feature: Refactor personal → SaaS multi-tenant](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_saas_refactor.md)
- [Feature: Payment via bank transfer](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_payment.md)
- [Feature: Admin tools & audit](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_admin_tools.md)
- [Runbook: Disaster recovery](file:///Users/YourName/Projects/My Money Went/docs/runbooks/disaster-recovery.md)
- [Observability plan](file:///Users/YourName/Projects/My Money Went/docs/observability-plan.md)
- [Implementation plan: scale to 500 users and more](file:///Users/YourName/Projects/My Money Went/docs/implementation-plan-500-users-and-more.md)
