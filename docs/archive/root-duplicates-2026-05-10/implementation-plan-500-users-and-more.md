...
> **Tham chiếu:** [BRD v2.9.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) · [PRD v1.6.0](file:///Users/YourName/Projects/MyMoneyWent/docs/prd.md) · [TDD v1.6.0](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd.md) · [Feature Spec Refactor SaaS v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_saas_refactor.md) · [Feature Spec Payment v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_payment.md) · [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_messenger_channel.md) · [Impl Plan VietQR+Email](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md)
...
| C10 | **Channel adapter pattern + Messenger MVP build** | Pre-launch (MVP) | Done — [feature-spec-messenger-channel v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_messenger_channel.md) + [impl plan VietQR+email v1.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md) | 10 ngày Messenger build (Phase 6 Tuần 10-11) + **3-5 ngày VietQR/email parallel** (integration/test surface, không phải 2 ngày) |
| C11 | **Landing page + Privacy policy + Terms** (pre-launch operational item) | Phase 7 (required cho Meta App Review + PDPA) | Done — [decision-onboarding-ui-strategy v1.0.1 §5.2 + §8](file:///Users/YourName/Projects/MyMoneyWent/docs/decision-onboarding-ui-strategy.md) | ~3 ngày dev (1 day landing + 1 day privacy + 1 day polish) |
| C12 | Web dashboard (read-only reports) | MRR >$300/mo + user feedback >30% request | Trigger-based, defer | 5-10 ngày dev khi trigger hit. Detail trong [decision-onboarding-ui-strategy §6 triggers](file:///Users/YourName/Projects/MyMoneyWent/docs/decision-onboarding-ui-strategy.md) |
...
- **C10 (NEW v1.3.0) channel adapter pattern** → `services/channels/{base,telegram,messenger}.py` adapter với `BaseSender` ABC. Foundation cho Messenger MVP build (Phase 6 Tuần 10-11) + Zalo/WhatsApp Phase 2+. Schema `users.channel_type` + `channel_user_id` thay `telegram_id UNIQUE`. Detail: [feature-spec-messenger-channel v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_messenger_channel.md).
...
**Spec scope:** [`docs/features/feature_admin_tools.md`](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_admin_tools.md)
...
**Document scope:** [`docs/observability-plan.md`](file:///Users/YourName/Projects/MyMoneyWent/docs/observability-plan.md)
