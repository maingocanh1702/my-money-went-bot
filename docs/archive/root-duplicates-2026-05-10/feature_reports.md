...
> **Tham chiếu:** [PRD v1.5.0 §3.5](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-en.md)
...
> **i18n:** All report text, headers, labels, section names served via `t(user.locale, key)`. Number format: vi → `1.500.000đ`, en → `1,500,000 VND`. Xem [feature_i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_i18n.md).
