...
> **Tham chiếu:** [PRD v1.5.0 §3.2](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-en.md)
...
> **i18n:** Transaction notification messages served via `t(user.locale, key)`. Xem [feature_i18n.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature_i18n.md).
