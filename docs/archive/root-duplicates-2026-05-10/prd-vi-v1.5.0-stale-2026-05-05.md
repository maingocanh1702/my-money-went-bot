...
> **Trạng thái:** Draft
> **Tham chiếu:** [brd.md](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/brd-vi.md) v2.8.0
...
| Observability | Sentry + Railway metrics + UptimeRobot. Founder daily dashboard `/admin_stats`, cost dashboard `/admin_cost`, per-user troubleshooter `/admin_user`. Error budget 0.1% policy. Detail: [observability-plan v1.1.0](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/observability-plan.md) |
| Disaster recovery | 8 scenarios documented + quarterly drill. RTO 2-4h, RPO 24h. `BOT_TOKEN_BACKUP` ready, `@TienVeNoiDauUpdates` channel for out-of-band notification. Detail: [DR runbook v1.1.0](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/runbooks/disaster-recovery.md) |
...
| **Error budget** | ≤0.1% error rate rolling 30-day window. Policy 3-tier (>50% remain → ship features / 0-50% → slow down / <0% → freeze). Detail: [observability §4b](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/observability-plan.md) |
| **Disaster recovery** | RTO ≤2h (DB corruption), ≤4h (Railway outage), ≤5min (BOT_TOKEN compromise). 8 scenarios documented: [DR runbook](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/runbooks/disaster-recovery.md) |
...
### 7.2. References
- [BRD v2.8.0](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/brd-vi.md)
- [TDD](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/tdd.md)
...
- [Runbook: Disaster recovery](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/runbooks/disaster-recovery.md)
- [Observability plan](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/observability-plan.md)
- [Implementation plan: scale to 500 users and more](file:///Users/YourName/Projects/Tiền Về Nơi Đâu/docs/implementation-plan-500-users-and-more.md)
