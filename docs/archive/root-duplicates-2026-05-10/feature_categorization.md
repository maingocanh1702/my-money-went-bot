...
> **Tham chiếu:** [PRD v1.5.0 §3.3](file:///Users/maingocanh/Projects/MyMoneyWent/docs/prd-en.md)
...
> **i18n:** All user-facing messages (picker prompt, confirmation, error) served via `t(user.locale, key)`. Button labels bilingual. Xem [feature_i18n.md](file:///Users/maingocanh/Projects/MyMoneyWent/docs/features/feature_i18n.md).
