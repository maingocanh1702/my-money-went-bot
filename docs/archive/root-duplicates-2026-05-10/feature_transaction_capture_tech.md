...
> **Version:** v1.0.0
> **Ngày tạo:** 2026-05-08
> **Feature doc:** [feature_transaction_capture.md](file:///Users/maingocanh/Projects/MyMoneyWent/docs/features/feature_transaction_capture.md)
> **TDD ref:** [TDD v1.6.0 §2.1 transactions, §3.2 pipeline](file:///Users/maingocanh/Projects/MyMoneyWent/docs/tdd.md)
...
INSERT INTO transactions (user_id, tx_date, description, direction, amount, ref_code, source, month_key)
...
async def process_transaction(user: User, raw_data: dict, source: str):
    ...
    if not await check_tier_limit(user):           # 4. Tier check
        ...
        return
    await db.insert_transaction(user.id, tx)       # 5. INSERT
    await send_category_picker(user, tx)           # 6. Picker
```
