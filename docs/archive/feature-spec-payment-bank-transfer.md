...
> **Tham chiếu:** [BRD v2.9.0 §5.2.4 Payment](file:///Users/YourName/Projects/MyMoneyWent/docs/brd.md) · [PRD v1.6.0 §F06 Pricing](file:///Users/YourName/Projects/MyMoneyWent/docs/prd.md) · [TDD v1.6.0 §5.2 env vars](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd.md) · [Feature Spec Refactor SaaS](file:///Users/YourName/Projects/MyMoneyWent/docs/feature-spec-refactor-saas.md) · [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/feature-spec-messenger-channel.md) · [Impl Plan VietQR+Email](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md)
...
> **Implementation detail:** [implementation-plan-payment-vietqr-email.md §4.5–4.6](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md) cho parser code + handler dispatch logic.
...
> **Detail spec:** [implementation-plan-payment-vietqr-email.md §4.1](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md) cho code + tests.
...
> **Channel-specific rendering:** Telegram dùng `sendPhoto` với caption inline. Messenger dùng `attachment.image` + caption gửi message kế tiếp ([Messenger spec §6.6](file:///Users/YourName/Projects/MyMoneyWent/docs/feature-spec-messenger-channel.md)). Cả 2 dùng cùng `messenger.send(user_id, {"type": "image", "url": ..., "caption": ...})` interface.
...
> **Implementation detail:** [implementation-plan-payment-vietqr-email.md §4.7](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md) cho `handlers/upgrade.py` modify code.
```
...
- [BRD v2.9.0 §5.2.4 Payment options](file:///Users/YourName/Projects/MyMoneyWent/docs/brd.md)
- [PRD v1.6.0 §F06 Pricing](file:///Users/YourName/Projects/MyMoneyWent/docs/prd.md)
- [TDD v1.6.0 §3 API Design + §5.2 env vars](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd.md)
- [Feature Spec Refactor SaaS §2.4 Email parser plugin](file:///Users/YourName/Projects/MyMoneyWent/docs/feature-spec-refactor-saas.md)
- [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/feature-spec-messenger-channel.md)
- [Implementation Plan VietQR + Email Parallel](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plan-payment-vietqr-email.md)
