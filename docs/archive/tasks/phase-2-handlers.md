...
> **Tuần:** 3-4
> **Depends on:** Phase 1 ✅
> **Roadmap:** [mymoneywent-roadmap.md](file:///Users/YourName/Projects/MyMoneyWent/docs/mymoneywent-roadmap.md)
> **Key spec:** [development-workflow.md §4](file:///Users/YourName/Projects/MyMoneyWent/docs/operations/development-workflow.md) — strangler fig, each handler = own PR
...
- [ ] **T2.01** `/start` handler — multi-tenant rewrite
  - Spec: [feature-onboarding.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-onboarding.md) + [BE tech](file:///Users/YourName/Projects/MyMoneyWent/docs/features/BE/feature-onboarding-tech.md)
  - AC:
...
- [ ] **T2.02** Category picker handler — inline buttons
  - Spec: [feature-categorization.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-categorization.md)
  - AC:
...
- [ ] **T2.03** `/manage` handler — CRUD categories
  - Spec: [feature-category-management.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-category-management.md)
  - AC:
...
- [ ] **T2.04** `/status` handler — monthly overview
  - Spec: [feature-reports.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-reports.md)
  - AC:
...
- [ ] **T2.06** `/settings` handler
  - Spec: [feature-settings.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-settings.md)
  - AC:
...
- [ ] **T2.07** `/accounts` handler + auto-discovery
  - Spec: [feature-funding-sources.md](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-funding-sources.md) + [BE tech](file:///Users/YourName/Projects/MyMoneyWent/docs/features/BE/feature-funding-sources-tech.md)
  - AC:
