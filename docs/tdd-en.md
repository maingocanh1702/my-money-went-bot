...
> **Status:** Draft
> **References:** [BRD-en v4.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-en.md) · [PRD-en v2.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-en.md) · [TDD-vi v1.8.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) (shared foundation) · [ADR-0001](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0001-monorepo-not-split-repos.md)
>
...
> **Note:** Core tables (`users`, `categories`, `sub_categories`, `transactions`, `bot_state`, `scheduled_jobs`, `admin_audit_log`, `analytics_events`) are defined in [tdd-vi.md §2.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) and shared across both markets. Below are **Global-specific additions.**
