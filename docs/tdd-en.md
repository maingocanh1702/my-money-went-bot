...
> **Status:** Draft
> **References:** [BRD-en v4.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-en.md) · [PRD-en v2.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-en.md) · [TDD-vi v1.9.0](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) (shared foundation) · [ADR-0001](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0001-monorepo-not-split-repos.md)
>
> **🌐 SCOPE NOTE:** This TDD specifies the **🌍 Global market technical architecture**. It shares foundation sections with [tdd-vi.md](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) (messenger interface, auth framework, admin tools, deployment). Global-specific sections: Plaid/TrueLayer/Tink bank integration, Stripe/PayPal/Shopify/Etsy OAuth, payout email parsers, web dashboard (Next.js), Stripe Checkout payment, `integrations` + `auto_cat_rules` tables. Per [ADR-0001](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0001-monorepo-not-split-repos.md), Global code lives at `markets/global/`, shared foundation at `core/`.
...
> **Note:** Core tables (`users`, `categories`, `sub_categories`, `transactions`, `bot_state`, `scheduled_jobs`, `admin_audit_log`, `analytics_events`) are defined in [tdd-vi.md §2.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) and shared across both markets. The `users` table now includes `channel_chat_id TEXT NULL` (migration 0004) and `chk_channel_type` expanded to include `'zalo'`. Below are **Global-specific additions.**
