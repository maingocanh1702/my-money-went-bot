...
> **Tham chiếu:** [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md) (canonical spec — what to build) · [BRD-vi v3.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) · [PRD-vi v1.7.1 §1.4](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md) · [TDD v1.8.0 §2.1 schema + §3.1 endpoints + §5.2 env vars](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) · [Impl Plan Telegram+Discord v2.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-telegram.md) (prerequisite — Phase 1-5) · [Impl Plan VietQR+Email v1.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md) (couples ở `send_image()`) · [Decision Onboarding UI v1.0.1](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md) (chat-only, no web form)
...
|---|---|---|
| Public launch timing | Code ship MVP, public access feature-flagged sau Meta App Review approve | [BRD-vi v3.1.0 §2.2 mục tiêu 4](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) |
| Channel mode | Single-channel per user (chọn 1 lúc onboarding) | [Messenger spec §1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md) |
| Onboarding UI | Chat-only (KHÔNG có web form) | [Decision Onboarding UI v1.0.1](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md) |
...
| Adapter pattern | `services/channels/{base,telegram,discord,messenger}.py` — base ABC + channel-specific impl. Foundation từ Phase 1-2 (Telegram + Discord co-primary) | [Refactor spec v1.3.0 §2.2](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md) |
...
| Web dashboard for Messenger users | Phase 9+ trigger-based | [Decision Onboarding UI §6](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md) |
...
- Privacy policy URL ready trước Day 3 (App Review submit) — **dependency: ship landing/privacy/terms TRƯỚC Tuần 11**, theo [decision-onboarding-ui-strategy §5.2](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md)
...
Pointer to canonical [feature-spec-messenger-channel §2-§5](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md). High-level:
...
**No DDL changes** trong scope plan này. Schema `users.channel_type`, `channel_user_id`, `last_user_message_at`, `invalid_channel`, UNIQUE pair constraint đều **đã ship Phase 1** ([TDD-vi v1.8.1 §2.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md)).
...
- [ ] **Verify privacy policy URL accessible** — `https://tienvenoidau.com/privacy` phải ship trước Day 3. Block dependency on landing/privacy/terms plan ([decision-onboarding-ui-strategy §5.2 + §8](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md)). Nếu chưa ship: block Day 3 App Review submit.
...
- [ ] (1h) Channel-specific copy templates `copy/onboarding.py` initial — refactor inline strings thành `COPY[key][channel_type]` pattern theo [Messenger spec §7.5](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md)
...
> **Couples với** [implementation-plan-payment-vietqr-email Day 1-2](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md). Code overlap, not duplicate work.
...
- [ ] (1.5h) Subscription payment Messenger adapter (couples [VietQR plan §6.6](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md)):
...
- [ ] (1h) Verify divergent copy theo [Messenger spec §7.5 UX parity matrix](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md):
...
- [ ] (1.5h) Privacy policy update Messenger section (theo [Messenger spec §6.7](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md)):
...
- [ ] (1h) Performance: bot reply latency p95 < 2s (per [Messenger spec §9.5 AC](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md))
...
- [ ] **Landing page + Privacy policy + Terms ship** ở `https://tienvenoidau.com/{,/privacy,/terms}` — depend on [decision-onboarding-ui-strategy §5.2 implementation](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md), **3 ngày dev separate task** trước Tuần 11
...
[Implementation Plan VietQR+Email v1.0.0 §5](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md) đặt VietQR work ở Tuần 12 với Day 1-4 breakdown. THIS plan đặt Messenger Day 6-7 cũng ở Tuần 12. **Họ couple, không double-count:**
...
- [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md) — canonical what to build
- [BRD-vi v3.1.0 §2.2 mục tiêu 4 + §8 Phase 7](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) — strategic decision
- [PRD-vi v1.7.1 §1.4 dual channel](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md) — product flow
- [TDD v1.8.0 §2.1 schema + §3.1 endpoints + §5.2 env vars](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) — technical foundation
- [Implementation Plan Telegram+Discord v2.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-telegram.md) — prerequisite (Phase 1-5, 48 days)
- [Implementation Plan VietQR+Email v1.0.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md) — couples Day 6-7
- [Decision Onboarding UI v1.0.1](file:///Users/YourName/Projects/MyMoneyWent/docs/adr/0002-onboarding-ui-strategy.md) — chat-only, no web form
...
- [Implementation Plan 500 users v1.4.0 §C10](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-500-users-and-more.md) — channel adapter foundation
