...
> **Tham chiếu:** [Feature: Onboarding](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-onboarding.md) · [Feature: i18n](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md) · [Feature: Discord](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-discord-channel.md) · [Feature: Transaction Capture](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-transaction-capture.md) · [Feature: Categorization](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-categorization.md) · [Feature: Category Management](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-category-management.md) · [Feature: Reports](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-reports.md) · [Feature: Pricing & Tiers](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-pricing-tiers.md) · [Feature: Settings](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-settings.md) · [Feature: Scheduled Jobs](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-scheduled-jobs.md) · [Feature: SaaS Refactor](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md) · [TDD v1.8.0](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) · [BRD-vi v3.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md)
...
| Discord | DM-first, slash commands, Rich Embeds, Ed25519 | [Discord spec](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-discord-channel.md) |
| ORM | No ORM, raw SQL | TDD §1.2 |

### 1.3. Out of scope

- Messenger channel (Phase 6, separate [plan](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-messenger.md))
- Payment integration (Phase 6, separate [plan](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-payment-vietqr-email.md))
- Admin tools (Phase 6)
...
|-----|------|--------|-------------|
| 1 | Railway PostgreSQL setup + DDL (`users`, `categories`, `sub_categories`, `transactions`, `bot_state`, `scheduled_jobs`, `admin_audit_log`, `analytics_events`) | All tables created | [SaaS Refactor](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md) |
...
| 4 | `services/channels/telegram.py` — `TelegramSender`. FastAPI app + `/webhook/telegram` endpoint. **`i18n/` module:** `__init__.py` (`t()` helper), `vi.py`, `en.py` language packs (~106 keys) | Telegram responds + i18n | [Onboarding](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-onboarding.md) · [i18n](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-i18n.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 11 | `handlers/manage.py` — `/manage` list categories. Show name, budget, spent | Category list | [Cat Mgmt](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-category-management.md) |
...
| 14 | `handlers/report.py` — `/status` monthly overview with progress bars | Monthly report | [Reports](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-reports.md) |
...
| 21 | Tier limit engine: `services/tier_check.py`. Integrate into manage + report | Tier enforcement | [Pricing](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-pricing-tiers.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 24 | `/hook/{token}` endpoint. `handlers/sepay.py` — parse SePay payload | Webhook receives | [Tx Capture](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-transaction-capture.md) |
| 25 | `services/tx_pipeline.py` — normalize → dedup → stale → tier → INSERT | Pipeline complete | Tx Capture |
| 26 | `handlers/transaction.py` — category picker (inline keyboard / Action Row buttons). 2-level: parent → sub → confirm | Picker UI (both channels) | [Categorization](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-categorization.md) |
...
| Day | Work | Output | Feature ref |
|-----|------|--------|-------------|
| 29 | `services/scheduler.py` — APScheduler poll loop. Daily recap fire 23:00 (DM for both Telegram + Discord) | Scheduler running | [Sched Jobs](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-scheduled-jobs.md) |
