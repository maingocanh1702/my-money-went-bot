...
> **Tham chiếu:** [BRD-vi v3.1.0](file:///Users/YourName/Projects/MyMoneyWent/docs/brd-vi.md) §5.2.4 · [PRD-vi v1.7.1](file:///Users/YourName/Projects/MyMoneyWent/docs/prd-vi.md) §3.6 F06 · [TDD-vi v1.8.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md) §3.1 endpoint routing + §5.2 env vars · [Feature Spec Payment v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md) §2.4 + §5.1 · [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md) §6.6 · [Implementation Plan 500 users v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-500-users-and-more.md)
...
**Gap 1 — Không có QR scan-to-pay.** `feature-payment.md` §5.1 hiện chỉ display text plain (số tài khoản + ref code), user gõ tay/copy paste vào mobile banking. Mỗi khâu copy-paste = 1 chỗ user có thể nhầm → tăng manual review queue, giảm conversion upgrade.
...
Bot send 3 message:
    ...
    └── User scan QR-TCB ──→ tiền vào TCB ──→ TCB email founder
                                              │
                                              ▼
                                    Forwarding rule: payment@in.tienvenoidau.com
                                              │
                                              ▼
...
- [ ] Confirm legal entity holder name (hộ kinh doanh — xem [Payment Spec §8](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md))
...
**Morning (3h):**
- [ ] Setup forwarding rule trong founder's Gmail (15m, manual): from TCB sender → `payment@in.tienvenoidau.com`
- [ ] Postmark Inbound config: route `payment@in.tienvenoidau.com` → POST `/inbound/{PLATFORM_TOKEN}` (15m + DNS propagation buffer)
...
- [ ] Postmark route `payment@in.tienvenoidau.com` → POST /inbound/{PLATFORM_TOKEN} working
...
| 3 | Founder Gmail forwarding rule bị disable accidentally | Trung bình | Email path silent fail, user TCB transfer không upgrade | Daily monitoring task: count emails received vào `payment@in.tienvenoidau.com` past 24h. Nếu 0 email + có >1 unmatched SePay → alert admin Telegram. Runbook trong DR runbook. |
...
| Doc | Section | Change |
|---|---|---|
| `feature-payment.md` | §5.1 Upgrade flow | Replace text-only display với 4-message structure (text + 2 QR + ref code) |
| `feature-payment.md` | §2.4 thêm | "VietQR via vietqr.io public image URL" + tradeoff note |
| `feature-payment.md` | §10 Phase plan | Tuần 11 thêm 3-5 ngày VietQR + email parallel (sub-tasks 10.11 + 10.12) |
| `feature-messenger-channel.md` | §6.6 | Cross-link tới spec này, confirm `send_image()` adapter pattern aligned |
...
- [Feature Spec Payment v1.3.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-payment.md)
- [Feature Spec Messenger v1.1.1](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-messenger-channel.md)
- [Feature Spec Refactor SaaS v1.2.0](file:///Users/YourName/Projects/MyMoneyWent/docs/features/feature-saas-refactor.md)
- [TDD-vi v1.8.1](file:///Users/YourName/Projects/MyMoneyWent/docs/tdd-vi.md)
- [Implementation Plan 500 users](file:///Users/YourName/Projects/MyMoneyWent/docs/implementation-plans/implementation-plan-500-users-and-more.md)
