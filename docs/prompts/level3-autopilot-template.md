...
> **Prerequisites:** Codex CLI at `/Users/YourName/Library/Application Support/crawbot/nodejs/bin/codex` (verified 2026-05-11)
...
Paste the block between `===PROMPT START===` and `===PROMPT END===` into a fresh Claude Code session in `/Users/YourName/Projects/MyMoneyWent`.
...
You are working in /Users/YourName/Projects/MyMoneyWent. No prior
conversation context. Codex CLI is available at
`/Users/YourName/Library/Application Support/crawbot/nodejs/bin/codex`
